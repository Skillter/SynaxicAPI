...
**IMPORTANT**: Claude Code should NEVER commit or push changes to git under any circumstances. All git operations (commit, push, pull requests, etc.) should be performed manually by the user.
...
- Merging branches
- Any other git operations that modify the repository
